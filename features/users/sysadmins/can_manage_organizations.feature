Feature: Admin can manage organizations
  ...
  Scenario: Admin can CRUD organizations
    ...
    And I select "Bilateral" from "organization_raw_type"
    ...
    And I select "January" from "organization_fy_start_month"
    ...
    And the "organization[raw_type]" field should contain "Bilateral"
