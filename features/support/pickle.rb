...
#
# Make sure that you are loading your FactoryGirl.create of choice in your cucumber environment
#
...
#
# You may also need to add gem dependencies on your FactoryGirl.create of choice in <tt>config/environments/cucumber.rb</tt>
