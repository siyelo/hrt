  ...
  context "budget" do
    [:purpose, :input, :location].each do |classification_type|
      ["on", "off"].each do |budget_type|
        context "#{ classification_type } ( #{ budget_type } budget )" do
          before :each do
            @project1.budget_type  = budget_type
            @project1.save
          ...
          it "generates proper report" do
            ...
            table[1]['On/Off Budget'].should == budget_type
            ...
            table[2]['On/Off Budget'].should == budget_type
            ...
            table[3]['On/Off Budget'].should == budget_type
