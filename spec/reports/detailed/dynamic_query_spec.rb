  ...
  describe "budget report" do
    ...
    context "simple reports" do
      ...
      it "should adjust total amount if there are 2 funders" do
        ...
        table[0]['Location Split %'].should == 100.0
        table[0]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[0]['Total Amount ($)'].round_with_precision(2).should == 66.67
        table[0]['Actual Double Count'].should == @is.double_count
        ...
        table[1]['Total Amount ($)'].round_with_precision(2).should == 33.33
      ...
      it "should adjusted total amount if there is 2 organizations and 2 implementers splits" do
        ...
        table[1]['Location Split %'].should == 100.0
        table[1]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[1]['Total Amount ($)'].round_with_precision(2).should == 100.00
        table[1]['Actual Double Count'].should == @is.double_count
      end
    end
    ...
    context "complex reports" do
      ...
      it "should adjust the total amounts as per codings (2 cost categorys splits)" do
        ...
        table[0]['Location Split %'].should == 100.0
        table[0]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[0]['Total Amount ($)'].round_with_precision(2).should == 75.00
        table[0]['Actual Double Count'].should == @is.double_count
        ...
        table[1]['Location Split %'].should == 100.0
        table[1]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[1]['Total Amount ($)'].round_with_precision(2).should == 25.00
        table[1]['Actual Double Count'].should == @is.double_count
      end
      ...
      it "should adjust the total amounts as per codings (2 coding budget splits)" do
        ...
        table[0]['Location Split %'].should == 100.0
        table[0]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[0]['Total Amount ($)'].round_with_precision(2).should == 80.00
        table[0]['Actual Double Count'].should == @is.double_count
        ...
        table[1]['Location Split %'].should == 100.0
        table[1]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[1]['Total Amount ($)'].round_with_precision(2).should == 20.00
        table[1]['Actual Double Count'].should == @is.double_count
      end
      ...
      it "should adjust the total amounts as per codings (2 location budget splits)" do
        ...
        table[0]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[0]['Total Amount ($)'].round_with_precision(2).should == 70.00
        table[0]['Actual Double Count'].should == @is.double_count
        ...
        table[1]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[1]['Total Amount ($)'].round_with_precision(2).should == 30.00
        table[1]['Actual Double Count'].should == @is.double_count
      end
      ...
      it "should adjust the total amounts as per codings (2 of each budget splits)" do
        ...
        table[0]['Location Split %'].should == 70.0
        table[0]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[0]['Total Amount ($)'].round_with_precision(2).should == 50.40
        table[0]['Actual Double Count'].should == @is.double_count
        ...
        table[1]['Location Split %'].should == 30.0
        table[1]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[1]['Total Amount ($)'].round_with_precision(2).should == 21.60
        table[1]['Actual Double Count'].should == @is.double_count
        ...
        table[2]['Total Amount ($)'].round_with_precision(2).should == 12.60
        ...
        table[3]['Total Amount ($)'].round_with_precision(2).should == 5.40
        ...
        table[4]['Total Amount ($)'].round_with_precision(2).should == 5.60
        ...
        table[5]['Total Amount ($)'].round_with_precision(2).should == 2.40
        ...
        table[6]['Total Amount ($)'].round_with_precision(2).should == 1.40
        ...
        table[7]['Total Amount ($)'].round_with_precision(2).should == 0.60
      ...
      it "should adjust the total amounts as per codings (2 of each budget splits and 2 funders)" do
        ...
        table[0]['Location Split %'].should == 70.0
        table[0]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[0]['Total Amount ($)'].round_with_precision(2).should == 33.60
        table[0]['Actual Double Count'].should == @is.double_count
        ...
        table[1]['Location Split %'].should == 30.0
        table[1]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[1]['Total Amount ($)'].round_with_precision(2).should == 14.40
        table[1]['Actual Double Count'].should == @is.double_count
        ...
        table[2]['Location Split %'].should == 70.0
        table[2]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[2]['Total Amount ($)'].round_with_precision(2).should == 8.40
        table[2]['Actual Double Count'].should == @is.double_count
        ...
        table[3]['Location Split %'].should == 30.0
        table[3]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[3]['Total Amount ($)'].round_with_precision(2).should == 3.60
        table[3]['Actual Double Count'].should == @is.double_count
        ...
        table[4]['Location Split %'].should == 70.0
        table[4]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[4]['Total Amount ($)'].round_with_precision(2).should == 3.73
        table[4]['Actual Double Count'].should == @is.double_count
        ...
        table[5]['Location Split %'].should == 30.0
        table[5]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[5]['Total Amount ($)'].round_with_precision(2).should == 1.60
        table[5]['Actual Double Count'].should == @is.double_count
        ...
        table[6]['Location Split %'].should == 70.0
        table[6]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[6]['Total Amount ($)'].round_with_precision(2).should == 0.93
        table[6]['Actual Double Count'].should == @is.double_count
        ...
        table[7]['Location Split %'].should == 30.0
        table[7]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[7]['Total Amount ($)'].round_with_precision(2).should == 0.40
        table[7]['Actual Double Count'].should == @is.double_count
        ...
        table[8]['Total Amount ($)'].round_with_precision(2).should == 16.80
        ...
        table[9]['Total Amount ($)'].round_with_precision(2).should == 7.20
        ...
        table[10]['Total Amount ($)'].round_with_precision(2).should == 4.20
        ...
        table[11]['Total Amount ($)'].round_with_precision(2).should == 1.80
        ...
        table[12]['Total Amount ($)'].round_with_precision(2).should == 1.87
        ...
        table[13]['Total Amount ($)'].round_with_precision(2).should == 0.80
        ...
        table[14]['Total Amount ($)'].round_with_precision(2).should == 0.47
        ...
        table[15]['Total Amount ($)'].round_with_precision(2).should == 0.20
    ...
    context "incomplete codings" do
      ...
      it "cost categorization - should replace incomplete codings with 'not coded' (should not affect calculated amounts)" do
        ...
        table[0]['Location Split %'].should == 70.0
        table[0]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[0]['Total Amount ($)'].round_with_precision(2).should == 37.33
        table[0]['Actual Double Count'].should == @is.double_count
        ...
        table[1]['Location Split %'].should == 30.0
        table[1]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[1]['Total Amount ($)'].round_with_precision(2).should == 16.00
        table[1]['Actual Double Count'].should == @is.double_count
        ...
        table[2]['Location Split %'].should == 70.0
        table[2]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[2]['Total Amount ($)'].round_with_precision(2).should == 9.33
        table[2]['Actual Double Count'].should == @is.double_count
        ...
        table[3]['Location Split %'].should == 30.0
        table[3]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[3]['Total Amount ($)'].round_with_precision(2).should == 4.00
        table[3]['Actual Double Count'].should == @is.double_count
        ...
        table[4]['Location Split %'].should == 70.0
        table[4]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[4]['Total Amount ($)'].round_with_precision(2).should == 18.67
        table[4]['Actual Double Count'].should == @is.double_count
        ...
        table[5]['Location Split %'].should == 30.0
        table[5]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[5]['Total Amount ($)'].round_with_precision(2).should == 8.00
        table[5]['Actual Double Count'].should == @is.double_count
        ...
        table[6]['Location Split %'].should == 70.0
        table[6]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[6]['Total Amount ($)'].round_with_precision(2).should == 4.67
        table[6]['Actual Double Count'].should == @is.double_count
    ...
    context "other costs without a project" do
      ...
      it "should adjust the total amounts as per codings (2 of each budget splits and 2 funders)" do
        ...
        sum.round_with_precision(2).should == 100.00
      end
    end
    ...
    context "currency conversion" do
      ...
      it "should convert amounts to USD" do
        ...
        table[0]['Location Split %'].should == 100.0
        table[0]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[0]['Total Amount ($)'].round_with_precision(2).should == 50.00
        table[0]['Actual Double Count'].should == @is.double_count
      end
    ...
    context "Incomplete classifications" do
      ...
      it "should create a purposes row with the outstanding amount (should make 2 rows)" do
        ...
        table[0]['Location Split %'].should == 100.0
        table[0]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[0]['Total Amount ($)'].round_with_precision(2).should == 90.00
        table[0]['Actual Double Count'].should == @is.double_count
        ...
        table[1]['Location Split %'].should == 100.0
        table[1]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[1]['Total Amount ($)'].round_with_precision(2).should == 10.00
        table[1]['Actual Double Count'].should == @is.double_count
      end
      ...
      it "should create a districts row with the outstanding amount (should make 2 rows)" do
        ...
        table[0]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
        table[0]['Total Amount ($)'].round_with_precision(2).should == 85.00
        table[0]['Actual Double Count'].should == @is.double_count
        ...
        table[1]['Total Amount ($)'].round_with_precision(2).should == 15.00
        table[1]['Actual Double Count'].should == @is.double_count
      end
      ...
      context "within allowed leeway" do
        it "should not create a inputs row with the outstanding amount (should make 1 row)" do
          ...
          table[0]['Location Split %'].should == 100.0
          table[0]['Name of District'].should == @activity.locations.map(&:short_display).join(",")
          table[0]['Total Amount ($)'].round_with_precision(2).should == 99.50
          table[0]['Actual Double Count'].should == @is.double_count
