...
describe Reports::Detailed::DistrictWorkplan do
  ...
  context "multiple organizations" do
    before :each do
      ...
      classifications1 = { @district1.id => 25, @district2.id => 75 }
      classifier1 = Classifier.new(activity3, :location, :budget)
      classifier1.update_classifications(classifications1)

      classifications2 = { @district1.id => 50, @district2.id => 50 }
      classifier2 = Classifier.new(activity3, :location, :spend)
      classifier2.update_classifications(classifications2)

      classifications3 = { @district1.id => 25, @district2.id => 75 }
      classifier3 = Classifier.new(activity4, :location, :budget)
      classifier3.update_classifications(classifications3)

      classifications4 = { @district1.id => 50, @district2.id => 50 }
      classifier4 = Classifier.new(activity4, :location, :spend)
      classifier4.update_classifications(classifications4)
    end
