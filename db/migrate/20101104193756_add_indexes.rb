class AddIndexes < ActiveRecord::Migration
  def self.up
    ...
    add_index "funding_flows", ["organization_id_from", "organization_id_to"], :name => 'index_ff_on_organization_id_from_and_organization_id_to'
    add_index "funding_flows", ["organization_id_to", "organization_id_from"], :name => 'index_ff_on_organization_id_to_and_organization_id_from'
  ...
  def self.down
    ...
    remove_index "funding_flows", :name => 'index_ff_on_organization_id_from_and_organization_id_to'
    remove_index "funding_flows", :name => 'index_ff_on_organization_id_to_and_organization_id_from'
