...
ActiveRecord::Schema.define(:version => 20121212091836) do
  ...
  create_table "code_splits", :force => true do |t|
    ...
    t.integer  "code_id"
    t.string   "type"
    t.decimal  "percentage",      :precision => 18, :scale => 3
  ...
  create_table "data_requests", :force => true do |t|
    ...
    t.integer  "inputs_version"
    t.integer  "beneficiaries_version"
  end
  ...
  create_table "organizations", :force => true do |t|
    ...
    t.boolean  "decomissioned",                    :default => false
  end
